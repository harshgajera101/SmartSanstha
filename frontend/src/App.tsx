...
// function App() {
//   // ✅ Load current page from sessionStorage on mount (persists across refreshes)
//   const [currentPage, setCurrentPage] = useState(() => {
//     return sessionStorage.getItem("currentPage") || "home";
//   });

//   // ✅ Load page data from sessionStorage if available
...
//   // ✅ Save page data to sessionStorage whenever it changes
//   useEffect(() => {
//     if (pageData) {
...
//       case "part-articles":
//         return (
//           <PartArticlesPage onNavigate={handleNavigation} partData={pageData} />
//         );
//       case "article":
//         return (
//           <ArticlePage onNavigate={handleNavigation} articleData={pageData} />
//         );
//       case "games":
...
//         ) : (
//           <HomePage onNavigate={handleNavigation} user={user} />
//         );
//       case 'admin-login':
//       return (
//         <AdminLoginPage
//           onLoginSuccess={handleLoginSuccess}
//           onBack={() => handleNavigation('auth')} // ✅ Use handleNavigation
//         />
//       );
//       case "contact":
//         return <ContactPage />;
//       case "auth":
//         return <AuthPage onLoginSuccess={handleLoginSuccess} onNavigate={handleNavigation} />;
...
//   if (currentPage === "auth" || currentPage === "admin-login") {
//     return (
...
export interface UserData {
  ...
  name: string;
  email: string;
  category?: string; // ✅ Make category optional for admin
  type?: string;
}
...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'dashboard':
        if (user?.type === 'admin') {
          // ✅ FIXED: Pass user directly (category is now optional)
          return <AdminDashboard admin={user} />;
        }
        return user ? (
          <Dashboard user={user} onNavigate={handleNavigation} />
